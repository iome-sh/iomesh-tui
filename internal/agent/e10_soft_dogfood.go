...
// ≠ Connected · ≠ dual_write ON · ≠ book-demo ON · ≠ live dogfood · soft offline ≠ invent Connected ·
...
const (
	...
	// E10SoftPass is session soft offline E10 residual PASS (≠ live dogfood · ≠ invent E10 closed · ≠ invent Connected).
...
// pass is residual soft offline only — never invents E10 closed / Connected / dual_write ON / live dogfood / live APPLY.
...
// Session soft marker ≠ live dogfood · residual PASS ≠ invent E10 closed · residual PASS ≠ invent Connected.
...
// Never dials MCP · never starts host · never invents E10 closed · Connected · dual_write ON · live APPLY green · live dogfood.
...
func RunE10OpenSoftDogfood() string {
	...
	b.WriteString(" · never dial MCP · never start host · residual PASS ≠ invent E10 closed · residual PASS ≠ invent Connected · dual_write stays OFF · E10 Open\n")
	...
	b.WriteString(" · Cloud Memory GA · dual_write OFF · book-demo OFF · residual-check\n")
	b.WriteString("\n")
	if pass {
		...
		b.WriteString("  result: FAIL (soft offline residual only · ≠ invent red product · residual PASS ≠ invent E10 closed · residual PASS ≠ invent Connected)\n")
	...
	b.WriteString(" · E10 Open · residual PASS ≠ invent E10 closed · residual PASS ≠ invent Connected\n")
	b.WriteString(" · Cloud Memory GA · dual_write OFF · book-demo OFF\n")
	b.WriteString(" · Cloud Memory GA · E10 stays Open · Cloud Memory GA ≠ close E10 · PASS ≠ live APPLY\n")
	...
	b.WriteString(" · residual PASS ≠ invent Connected · residual PASS ≠ invent E10 closed\n")
