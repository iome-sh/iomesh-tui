...
// Session-only: default e4_soft_not_run. Soft offline pass/fail ≠ invent Connected ·
...
const (
	...
	// E4SoftPass is session soft offline E4 residual PASS (≠ live dogfood · ≠ invent Connected).
