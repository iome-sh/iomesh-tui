...
// Session-only: default wizard_soft_not_run. Soft offline pass/fail ≠ invent Connected ·
...
const (
	...
	// WizardSoftPass is session soft offline wizard residual PASS (≠ live dogfood · ≠ invent Connected).
...
// pass is residual soft offline only — never invents Connected / dual_write ON / live dogfood / SSO / auto-host.
...
// Never dials MCP · never starts host · never invents Connected · dual_write ON ·
