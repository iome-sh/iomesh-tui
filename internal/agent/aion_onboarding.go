...
// /onboard next marketing-demo (s1590 + s1594 sales talk track). Short operator script
// for videos/sales demos of local agent + local memory. Prefer clear steps over residual
// continuum jargon walls. Static offline board — no MCP dial · never starts host.
//
// Script:
...
//
// Sales talk track (s1594, optional spoken bullets): local agent + memory beat ·
// private tool-marketing claims catalog for demoable vs do-not-claim · win-back /
// closed-lost are human/HITL sales process (not auto-CRM from TUI).
//
...
// free eng s1590 · s1594 sales talk track · free-floor peer s1592+ mention only.
func AionAgentOnboardingNextMarketingDemoLane() string {
  ...
  Audience: demo hosts · sales eng · GTM video capture · free eng s1590 · s1594 sales talk track · free-floor peer s1592+ mention only
  ...
  Sales talk track (optional spoken bullets · s1594):
...
Locks: dual_write OFF · book-demo OFF · not Memory GA · local memory · local-primary · iomesh-memory-mcp · mesh optional · never invent Connected · never invent install green / INSTALL_STORE APPLY · dual_write stays OFF (never invent primary ON) · free eng s1590 · s1594 sales talk track · free-floor peer s1592+ mention only`)
}
