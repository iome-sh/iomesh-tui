...
// AionAgentOnboardingGuidanceNote residual-honest system note (s1363 + s1368 + s1372).
...
func AionAgentOnboardingGuidanceNote() string {
	return strings.TrimSpace(`aion agent onboarding (residual-honest TUI ↔ aion CP/MCP · s1363+s1368+s1372):
...
7. Post-onboard continuum: /onboard next (plugins dogfood · /gtm checklist · aion-memory-mcp local · portal HITL still)
...
// AionAgentOnboardingChecklist residual-honest numbered onboarding checklist (s1363 + s1368 + s1372).
...
func AionAgentOnboardingChecklist() string {
	return strings.TrimSpace(`aion agent onboarding checklist (residual-honest · s1363+s1368+s1372 · TUI ↔ aion):
  ...
  9. Post-onboard: /onboard next (plugins · gtm · memory local · portal HITL still)
...
// AionAgentOnboardingStatus residual-honest static offline status lines for /onboard status (s1368 + s1372).
...
func AionAgentOnboardingStatus() string {
	return strings.TrimSpace(`aion onboard status (residual-honest · offline static · s1368+s1372):
  ...
  slash: /onboard portal · /onboard checklist · /onboard next · /integrations status`)
}

// AionAgentOnboardingNextLanes residual-honest post-onboard continuum for /onboard next (s1372).
...
func AionAgentOnboardingNextLanes() string {
	return strings.TrimSpace(`aion onboard next lanes (residual-honest · post-onboard continuum · s1372 · no MCP dial):
