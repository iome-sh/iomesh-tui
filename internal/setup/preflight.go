...
const meshPortalAPIv1AsBrokerNote = "mesh endpoint host looks like apiv1.* — that is portal/catalog CP, not broker streams · streams/consumers live on hooks.* (e.g. hooks.<env>.iome.sh) · catalog ≠ Connected · infer ≠ Connected"
