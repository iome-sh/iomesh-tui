...
// package load ≠ Connected · free eng s1829.
func PluginsNextStepLines() []string {
	return []string{
		...
		"note: Discover ≠ Connected · soft offline smoke ≠ invent Agent Plugins GA · package load ≠ Connected · dual_write OFF · free eng s1829",
	}
}
