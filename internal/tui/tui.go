			...
			case "next", "after", "continue", "lanes":
				...
				if len(parts) >= 3 {
					...
					case "marketing-demo", "marketing", "sales-demo", "demo-script", "gtm-demo":
						...
						fmt.Fprintln(out, "— marketing-demo: s1590 · plain-language local agent + local memory script · Mode A sticky /memory digest --require-sources mesh,private · palace path printed · air-gap no fake Connected · pins TUI v1.3.0 · MCP v0.1.1+post-pin · memory v1.5.8 · dual_write OFF · local memory · not Memory GA · mesh optional · never invent Connected · book-demo OFF · free eng s1590 · free-floor peer s1592+ mention only · NOT bare demo (demo readiness) · NOT bare sales · NOT bare gtm")
						return false, nil
