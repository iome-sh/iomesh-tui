...
func TestLoadBuiltin_S1363AionAgentOnboardingSkillDogfood(t *testing.T) {
	...
	for _, want := range []string{
		...
		"soft_offline_portal_hitl_session_fail",
		"portal-hitl-soft",
		"journey stage 5",
		...
		"soft_offline_tool_call_session_fail",
		"tool-call-soft",
		...
		"soft_offline_wizard_session_fail",
		"wizard-soft",
		...
		"plugins|gtm|memory|mesh|memory-pull|agentic|portal-hitl|e4|tool-call|e10|planes|sales|demo|operator|setup|journey|wizard|status|export|human-gates",
...
// Extended s1530 P5 + s1534 P6 + s1538 P7: pull/analyze/drift/repair opt-in honesty.
