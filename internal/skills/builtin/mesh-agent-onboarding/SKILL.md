...
description: Residual-honest TUI agent ↔ mesh CP/MCP onboarding (portal Agent/MCP mint/copy/probe · list/plan connectors → portal HITL · memory dual_write OFF · not Memory GA · never invent Connected)
---
...
3g2. **Marketing demo path — plain-language operator script** for videos and sales demos of **local agent + local memory**.
   ...
   - dual_write **OFF** · local memory · **not Memory GA** · mesh optional · **never invent Connected** · book-demo **OFF**.
...
3n. **E10 Open reaffirm residual-check (Platform residual honesty after OSS packaging)** — residual-honest offline board pinning E10 Open · never invent E10 closed / Edge Memory GA declared / live APPLY green.
   - Path: pin **E10 Open** · residual PASS ≠ invent E10 closed · residual PASS ≠ invent Edge Memory GA declared · Edge Memory GA candidacy only · founder sign-off only if declaring Edge Memory GA · candidacy allowed without E10 · PASS ≠ live APPLY · dual_write OFF · book-demo OFF · not Memory GA.
...
- Edge-user-journey first-run map (s1558 Wave B): `MeshAgentOnboardingNextJourneyLane` · slash `/onboard next journey` (aliases edge-journey|user-journey|first-run|edge_user_journey) · 7 stages residual-honest · dual_write OFF · not Memory GA · Edge Memory GA candidacy only · residual PASS ≠ invent Edge Memory GA · portal HITL · no invent TUI portal SSO · host not auto · free eng s1558 · free-floor peer s1560+ mention only · docs edge-user-journey · setup-lifecycle · memory-edge-usage-demo.
...
- Human-gates honesty board (s1413+s1546+s1550+s1574 Wave C continuum): `MeshAgentHumanGatesHonestyBoard` · slash `/onboard next human-gates` (aliases `human` / `gates` / `apply-gates` / `still-human` / `apply-residual`) — still-human APPLY open · edge-first · knowledge multi-tenant punted · Slack HMAC punted · portal HITL when connect · dual_write OFF · not Memory GA · Edge Memory GA candidacy only · residual PASS ≠ invent Edge Memory GA · residual PASS ≠ invent Edge Memory GA declared · E10 Open · PASS ≠ invent Connected · PASS ≠ invent human-gate green · PASS ≠ live APPLY · open boxes stay open · H1/H2 not launch gate · agent MCP cannot write installs · book-demo OFF · leave ON_SIGNAL unset · free eng s1574.
