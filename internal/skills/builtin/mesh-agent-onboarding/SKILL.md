...
- **Marketing demo path (s1590):** `/onboard next marketing-demo` (aliases `marketing` / `sales-demo` / `demo-script` / `gtm-demo`) → `MeshAgentOnboardingNextMarketingDemoLane` — plain-language operator script for videos/sales · local agent + local memory · dual_write **OFF** · mesh optional · **never invent Connected / Memory GA** · free eng **s1590** · docs `marketing-demo-path.md` · **do not steal** bare `demo` / `sales` / `gtm`.
...
3f. **Sales / buyer claims residual-honest matrix** — offline static board for founders/sales operators (may claim vs must not claim).
   ...
   - Honesty locks: drafts only for GTM · book-demo **OFF** · dual_write **OFF** · never invent Connected · residual PASS ≠ live dogfood · PASS ≠ live APPLY · open boxes stay open · rates ~$88/$119 optional · `dual_auth_candidacy_open` · tool ship ≠ dual-auth live · mesh ≠ memory · no invent GA.
...
3i. **Setup lifecycle residual-honest map** — offline static consolidation of setup P1–P7 story (init · preflight · reload · portal · pull · analyze · drift · guided repair) · **stage 4** of edge-user-journey.
   ...
   - **repair apply ≠ invent Connected** · dual_write **OFF** · Edge Memory GA candidacy only · portal HITL · catalog ≠ Connected · **E10 Open** · still-human APPLY open · free eng **s1558**.
...
3j. **7-stage edge-user-journey first-run residual-honest map** — offline static first-run operator surface after Wave A docs SSOT (s1554).
   ...
   - Honesty: dual_write **OFF** · Edge Memory GA candidacy only · residual PASS ≠ invent Edge Memory GA · portal HITL · agent MCP cannot write installs · catalog ≠ Connected · book-demo **OFF** · free eng **s1558** · free-floor peer **s1560+** mention only.
...
3k. **Portal HITL connectors (journey stage 5)** — residual-honest offline board for MCP list/plan → browser portal HITL → human OAuth/install.
   ...
   - **agent MCP cannot write installs** · **catalog ≠ Connected** · `template=` ≠ install APPLY · portal HITL still · dual_write OFF · book-demo OFF · Edge Memory GA candidacy only · residual PASS ≠ invent Edge Memory GA.
...
3l. **E4 client attach (journey stage 6 local store / MCP attach)** — residual-honest offline board for lean `iomesh-memory-mcp` → `iomesh mcp --connect` · tools=6 stamp residual.
   ...
   - **dual_write OFF** · Edge Memory GA candidacy only · residual PASS ≠ invent Edge Memory GA declared · **E10 Open** · tip ≠ invent forever-green product dogfood · residual PASS ≠ live dogfood · PASS ≠ live APPLY · book-demo OFF.
...
3m. **Deeper tool-call residual (journey stage 6/7 depth after E4 attach)** — residual-honest offline operator map for ingest → retrieve → list → as-of/status after tools=6 attach stamp.
   ...
   - Soft offline dogfood: `/onboard next tool-call dogfood` (aliases 4th token `soft` / `samples` / `offline` / `tool-call-soft`) → `RunDeeperToolCallSoftDogfood`.
     ...
     - **never dial MCP · never start host** · soft offline ≠ invent Connected · session soft ≠ live dogfood · residual PASS ≠ live dogfood · residual PASS ≠ invent Edge Memory GA declared · independent of E4 soft (s1566) · still-human soft (s1574) · wizard/portal HITL/agentic soft.
...
3n. **E10 Open reaffirm residual-check (Platform residual honesty after OSS packaging)** — residual-honest offline board pinning E10 Open · never invent E10 closed / Edge Memory GA declared / live APPLY green.
   - Path: pin **E10 Open** · residual PASS ≠ invent E10 closed · residual PASS ≠ invent Edge Memory GA declared · Edge Memory GA candidacy only · founder sign-off only if declaring Edge Memory GA · candidacy allowed without E10 · PASS ≠ live APPLY · dual_write OFF · book-demo OFF.
...
3h. **Operator readiness residual-honest matrix** — offline static board consolidating demo · sales · planes · human-gates for founders/operators.
   ...
   - **Row 4 Human gates:** edge-first · knowledge multi-tenant punted · Slack HMAC punted · portal HITL when connect · companion `/onboard next human-gates` · dual_write OFF · Edge Memory GA candidacy only.
   ...
   - **Row 6 Policy locks:** dual_write **OFF** · leave ON_SIGNAL unset · rates ~$88/$119 optional · no invent GA.
...
7. **Residual-honest human-gates status** — edge-first launch residual vs punted/demoted vs offline residual only / shipped-or-policy · still-human APPLY open inventory reaffirm after Wave A–C continuum.
   ...
   - **still_human_or_policy (edge-first launch residual · still-human APPLY open):** portal HITL OAuth/connect when customer must Connect · catalog ≠ Connected · book-demo OFF · leave ON_SIGNAL unset · dual_write OFF · Edge Memory GA candidacy only · E10 Open · residual PASS ≠ invent Edge Memory GA declared · E10 founder sign-off only if claiming Edge Memory GA · optional E4 edge dogfood if tightening claim beyond candidacy.
   ...
   - **offline_residual_only / shipped_or_policy:** setup lifecycle residual complete ≠ invent Connected / Memory GA · Wave A–C continuum residual ≠ invent human-gate green / live APPLY · agent MCP list/plan residual-honest · dual_write OFF · Edge Memory GA candidacy only · local memory / dual_write OFF do NOT invent Edge Memory GA declared.
   - Operator: `/onboard next human-gates` · `/onboard next human-gates dogfood` · `/onboard next e10` (s1586 E10 Open reaffirm) · `/onboard next e10 dogfood` · `/onboard next wizard` · `/onboard next setup` · `/integrations list|plan|status` · **never invent Connected / INSTALL_STORE green / Edge Memory GA / book-demo ON / human-gate green / E10 closed**.
...
- Do **not** invent Memory GA / platform GA from public product attach residual (`iomesh-memory-mcp` go install · no GOPRIVATE · dual_write OFF · flip complete residual ≠ invent Memory GA · public OSS ≠ invent platform GA · control-plane / broker private · s1478).
...
- Do **not** treat E10 soft offline residual-check pass/fail as invent E10 closed / Edge Memory GA declared / live APPLY green / live dogfood (s1586 · `e10_soft_not_run` default · never dial MCP · never start host · residual PASS ≠ invent E10 closed · residual PASS ≠ invent Edge Memory GA declared · residual PASS ≠ live dogfood · residual-check).
...
- Edge-user-journey first-run map (s1558 Wave B): `MeshAgentOnboardingNextJourneyLane` · slash `/onboard next journey` (aliases edge-journey|user-journey|first-run|edge_user_journey) · 7 stages residual-honest · dual_write OFF · Edge Memory GA candidacy only · residual PASS ≠ invent Edge Memory GA · portal HITL · no invent TUI portal SSO · host not auto · free eng s1558 · free-floor peer s1560+ mention only · docs edge-user-journey · setup-lifecycle · memory-edge-usage-demo.
...
- Human-gates honesty board (s1413+s1546+s1550+s1574 Wave C continuum): `MeshAgentHumanGatesHonestyBoard` · slash `/onboard next human-gates` (aliases `human` / `gates` / `apply-gates` / `still-human` / `apply-residual`) — still-human APPLY open · edge-first · knowledge multi-tenant punted · Slack HMAC punted · portal HITL when connect · dual_write OFF · Edge Memory GA candidacy only · residual PASS ≠ invent Edge Memory GA · residual PASS ≠ invent Edge Memory GA declared · E10 Open · PASS ≠ invent Connected · PASS ≠ invent human-gate green · PASS ≠ live APPLY · open boxes stay open · H1/H2 not launch gate · agent MCP cannot write installs · book-demo OFF · leave ON_SIGNAL unset · free eng s1574.
