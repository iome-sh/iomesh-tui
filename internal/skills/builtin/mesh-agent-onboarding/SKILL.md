...
- **Marketing demo path (s1590):** `/onboard next marketing-demo` (aliases `marketing` / `sales-demo` / `demo-script` / `gtm-demo`) → `MeshAgentOnboardingNextMarketingDemoLane` — plain-language operator script for videos/sales · local agent + local memory · dual_write **OFF** · mesh optional · **never invent Connected · Cloud Memory GA** · free eng **s1590** · docs `marketing-demo-path.md` · **do not steal** bare `demo` / `sales` / `gtm`.
...
3g2. **Marketing demo path — plain-language operator script** for videos and sales demos of **local agent + local memory**.
   ...
   - Docs: `docs/architecture/marketing-demo-path.md` · companion `memory-edge-usage-demo.md` · `edge-user-journey.md`.
...
3m. **Deeper tool-call residual (journey stage 6/7 depth after E4 attach)** — residual-honest offline operator map for ingest → retrieve → list → as-of/status after tools=6 attach stamp.
   ...
   - Companion: `/onboard next e4` · `/onboard next e4 dogfood` · `/onboard next e10` (s1586) · `/onboard next memory` · `/onboard next journey` · `/memory status` · docs `docs/EDGE_MEMORY_E4_CLIENT_ATTACH_EVIDENCE.md`.
...
3n. **E10 Open reaffirm residual-check (Platform residual honesty after OSS packaging)** — residual-honest offline board pinning E10 Open · never invent E10 closed / Connected / live APPLY green.
   ...
   - Companion: `/onboard next e4` · `/onboard next human-gates` · `/onboard next tool-call` · OSS packaging · MIT harness · not control plane · docs `docs/architecture/oss-packaging-boundary.md` · `docs/architecture/edge-user-journey.md` · `docs/EDGE_MEMORY_E4_CLIENT_ATTACH_EVIDENCE.md`.
...
- Marketing demo path (s1590): `MeshAgentOnboardingNextMarketingDemoLane` · slash `/onboard next marketing-demo` (aliases marketing|sales-demo|demo-script|gtm-demo) · plain-language local agent + local memory script · dual_write OFF · mesh optional · never invent Connected · free eng s1590 · docs marketing-demo-path.md.
