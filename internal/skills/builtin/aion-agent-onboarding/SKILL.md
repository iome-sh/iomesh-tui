...
### D. Post-onboard next lanes (operator continuum · s1372+s1377+s1382+s1387+s1397+s1402+s1407+s1413+s1417+s1422+s1427+s1432+s1437+s1442+s1447+s1542+s1558 · no MCP dial)
...
3j. **7-stage edge-user-journey first-run residual-honest map** — offline static first-run operator surface after Wave A docs SSOT (s1554).
   - Stages: **1 Signup** (portal · optional pure local) · **2 Download TUI** · **3 TUI auth/keys** (LLM/Ollama · no invent TUI portal SSO) · **4 Setup wizard** (`/setup` · `/onboard next setup`) · **5 Connectors** (`/integrations` list/plan · portal HITL) · **6 Local store** (`iomesh-memory-mcp` · host not auto) · **7 Analyze** (`/memory digest` · `/setup analyze`).
   ...
   - Companion: `/onboard next setup` · `/onboard next agentic` · `/onboard next memory` · `/onboard next human-gates` · `/onboard next operator` · docs `docs/architecture/edge-user-journey.md` · `docs/architecture/setup-lifecycle.md` · `docs/architecture/memory-edge-usage-demo.md`.
