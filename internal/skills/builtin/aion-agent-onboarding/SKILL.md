...
| tool-call | `/onboard next tool-call` | `tool-calls` · `deeper-e4` · `e4-tools` · `ingest-retrieve` · `tool_call` | `AionAgentOnboardingNextToolCallLane` |
| tool-call dogfood | `/onboard next tool-call dogfood` | `soft` · `samples` · `offline` · `tool-call-soft` | `RunDeeperToolCallSoftDogfood` |
| e10 | `/onboard next e10` | `e10-open` · `edge-memory-e10` · `ga-signoff` · `e10_open` | `AionAgentOnboardingNextE10Lane` |
...
| marketing-demo | `/onboard next marketing-demo` | `marketing` · `sales-demo` · `demo-script` · `gtm-demo` | `AionAgentOnboardingNextMarketingDemoLane` |
...
3g2. **Marketing demo path — plain-language operator script** for videos and sales demos of **local agent + local memory**.
   ...
   - API: `AionAgentOnboardingNextMarketingDemoLane`.
...
3m. **Deeper tool-call residual (journey stage 6/7 depth after E4 attach)** — residual-honest offline operator map for ingest → retrieve → list → as-of/status after tools=6 attach stamp.
   ...
   - API: `AionAgentOnboardingNextToolCallLane` · `RunDeeperToolCallSoftDogfood` · `ToolCallSoftSessionLabel`.
...
3n. **E10 Open reaffirm residual-check (Platform residual honesty after OSS packaging)** — residual-honest offline board pinning E10 Open · never invent E10 closed / Edge Memory GA declared / live APPLY green.
   ...
   - API: `AionAgentOnboardingNextE10Lane` · `RunE10OpenSoftDogfood` · `E10SoftSessionLabel`.
...
- Marketing demo path (s1590): `AionAgentOnboardingNextMarketingDemoLane` · slash `/onboard next marketing-demo` (aliases marketing|sales-demo|demo-script|gtm-demo) · plain-language local agent + local memory script · dual_write OFF · mesh optional · never invent Connected · free eng s1590 · docs marketing-demo-path.md.
