...
- Public install: `go install github.com/iome-sh/iomesh-memory-mcp/cmd/iomesh-memory-mcp@v0.4.2` · **no GOPRIVATE** (`@main` is tip of default branch, not a production pin)
