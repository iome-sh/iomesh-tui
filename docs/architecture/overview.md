...
60. ~~Release v0.76.0 packaging cut (s1835)~~ **done** — residual next-step honesty continuum packaged: onboard status/checklist/next/portal (s1825) · plugins list/validate/smoke/status (s1829) · memory status/help/digest (s1831) · dual_write OFF · package wire ≠ Connected · catalog ≠ Connected · Discover ≠ Connected · not Memory GA · not invent Agent Plugins GA
61. ~~Release v0.77.0 packaging cut (s1992)~~ **done** — heartbeat dashboard (`/dashboard`) + README showcase (s1989–s1990) · start-here/MCP (s1982) · skills next-step (s1837) · dual_write OFF · catalog ≠ Connected · eval template ≠ Connected · not Memory GA · not live APPLY
62. ~~Release v1.0.0 packaging cut (s2088)~~ **done** — first SemVer 1.0; no longer 0.x / Beta / MVP tags. Packages consume honesty + mesh create + infer broker + `/setup --config` + integrate-app UX since v0.77.0. v1.0 ≠ Memory GA · ≠ live HITL closed · Knowledge/Analytics stay Beta · catalog ≠ Connected · dual_write OFF
