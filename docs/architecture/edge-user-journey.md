...
**Serial:** free eng **s1554** (Wave A docs SSOT) · **s1558** (Wave B first-run polish residual) · **s1562** (stage-5 portal HITL soft dogfood residual) · **s1566** (stage-6 E4 client-attach soft dogfood residual) · **s1570** (Wave C first-run wizard residual) · **s1574** (still-human APPLY soft dogfood residual) · residual-honest **edge-first product narrative**  
**Status:** Wave A docs SSOT **shipped** · Wave B first-run polish **partially in product** · Wave C guided wizard residual **shipped residual-honest** (`/onboard next journey` + setup stage-4 map · stage-5 `/onboard next portal-hitl` soft dogfood residual · stage-6 `/onboard next e4` soft dogfood residual · Wave C `/onboard next wizard` + soft dogfood residual) · still-human APPLY soft residual **s1574** (`/onboard next human-gates dogfood`)  
...
**Free-floor peer:** free-floor ownership remains **s1556+** / Wave B mention **s1560+** / stage-6 E4 mention **s1568+** / Wave C mention **s1572+** / still-human APPLY mention **s1576+** (mention only). Residual product narrative **does not** rewrite free-floor.
