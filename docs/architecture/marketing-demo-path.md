...
**Serial:** free eng **s1590** · sales talk track **s1594** · GTM claim-support **s1598** · operator GTM boundary **s1602** · GTM wave 6 **s1606**  
...
### Operator GTM boundary (s1602 · s1606)
...
free eng **s1590** · sales talk track **s1594** · GTM claim-support **s1598** · operator GTM boundary **s1602** · GTM wave 6 **s1606** · free-floor peer **s1592+** mention only (do not rewrite free-floor ownership from this doc).
