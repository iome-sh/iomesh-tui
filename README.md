...
> **Status:** public open-source **v0.74.x** (pre-1.0, **Beta**). Shipped: agent loop · subagents · full-screen TUI · permissions · ACP · skills · MCP client · **local memory attach** · multi-model catalog (DeepSeek · Grok · Gemini · Vertex · Ollama). Optional mesh client when pointed at a broker you run or subscribe to.
...
go install github.com/iome-sh/iomesh-tui/cmd/iomesh@v0.74.0
